...
3. [If Rand()%10 is Bad, How to Use TRNG Efficiently?](https://www.apwdsit.org/Program).
...
4. [An Information Theory of Query Optimization](https://www.mfo.de/www/activity/2537).
...
6. [How to Speak Tensor](https://umi.dm.unibo.it/jm-umi-ams/special-sessions/special-sessions-on-25-26-july-2024/).
  *International AMS-UMI Joint Meeting*.
  July 2024, Palermo, Italy.
  ([Slides](https://github.com/Symbol1/SpeakTensor))

7. [Geno-Weaving: Low-Complexity Capacity-Achieving Data Storage on DNA](https://www.ce.cit.tum.de/en/lnt/events/2024-coding-theory-and-algorithms-for-dna-based-data-storage/program/).
...
8. [GenoWeave: Interleaving Polar Codes Across Strands for DNA Data Storage](https://ita.ucsd.edu/workshop/schedule).
...
9. [Channel Manipulation as a Coding Technique](https://meetings.ams.org/math/jmm2024/meetingapp.cgi/Paper/29146).
   *Joint Mathematics Meetings (JMM)*.
   January 2024, San Francisco, California.
   ([Slides](https://github.com/Symbol1/ChannelManipul))

10. [Moulin Codes](https://meetings.siam.org/sess/dsp_talk.cfm?p=116047).
