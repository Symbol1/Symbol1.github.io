...
\fs2
                               ...
                               Hsin-Po Wang \kern5pt \texttc{王新博}

\fs0
            Google Scholar: \url{https://scholar.google.com/citations?user=tJ8-ChgAAAAJ}

          Website: \url{https://www.hsin-po.wang} \kern45pt Email: \email{hsinpo@ntu.edu.tw}
...
PhD in Math \hfill        University of Illinois Urbana-Champaign, Illinois        \hfill 2016--2021

BSc in Math \hfill     National Taiwan University \texttc{國立臺灣大學}, Taiwan    \hfill 2011--2015
...
Substitute Service \texttc{教育服務役}                            \hfill September 2015--August 2016

\sec{Research Interests}

\def\interest#1{\textcolor{red!30!black}{#1}}
\def\work#1{\textcolor{yellow!30!black}{#1}}
\def\apply#1{\textcolor{green!30!black}{#1}}
...
\work{distributed matrix multiplication} (cloud computation),
\work{DNA digital data storage} (archival storage),
\work{exact distribution shaping} (randomized algorithm), and
\work{pessimistic cardinality estimation} (database optimization).
I specialize in finding applications of
\apply{algebra},
\apply{combinatorics},
\apply{calculus},
\apply{probability theory},
and other mathematical tools to these topics.

\sec{Awards and Honors}

\texttc{臺大富邦拔萃學者} NTU-Fubon Distinguished Scholar                          \hfill 2024--2027
...
\#2 cumulative GPA upon graduation \texttc{理學院院長獎}                                 \hfill 2015

Top 5\% GPA \texttc{書卷獎}                              \hfill Fall 2015, Spring 2014, Spring 2013,
...
\begin{thebibliography}{C99}
    \bibitem[C15]{C15}
    Shuo-Ting Hsu, Hsin-Po Wang, I-Hsiang Wang.
    \href{simple.one}
    {Not-So-Perfect Hashing for Massive Random Access}
    \emph{IEEE Information Theory Workshop (ITW)}.
    ...
    \bibitem[C13]{C13}
    Y-T Lin, H-P Wang.
    \href{https://arxiv.org/abs/2604.14647}
...
\begin{thebibliography}{T99}
    \bibitem[T10]{T10}
    \href{https://husihuang.github.io/workshop.html}
    {Not-So-Perfect Hashing: Downlink and Uplink}.
    \emph{Qingdao Workshop on Coding Theory and Related Topics}.
    June 2026, Qingdao, China.

    \bibitem[T9]{T9}
    \href{https://brinmrc.umd.edu/fall25-ibdgcct/}
    {Sidorenko-Inspired Pessimistic Cardinality Estimation for Join Queries}.
    \emph{The Interplay Between Distance Geometry, Combinatorics, and Coding Theory (BrinMRC workshop)}.
    November 2025, College Park, Maryland.

    \bibitem[T8]{T8}
    \href{https://www.apwdsit.org/Program}
    {If Rand()\%10 is Bad, How to Use TRNG Efficiently?}.
    \emph{Asia Pacific Workshop on Data Science and Information Theory (APWDSIT)}.
    ...
    \emph{Guangzhou, Hong Kong and Taipei Joint Workshop on Artificial Intelligence, Communications and Information Theory (AICIT 2025)}.
    ...
    \emph{Coding Theory and Algorithms for DNA-based Data Storage (ISIT's satellite workshop)}.
    July 2024, Athens, Greece.
    ...
    \bibitem[T1]{T1}
    \href{https://meetings.siam.org/sess/dsp_talk.cfm?p=116047}
    {Moulin Codes}.
