...
\texttc{理學院院長獎} (Dean's List \#2 when graduation)                                  \hfill 2015

\texttc{書卷獎} (top 5\% GPA)      \hfill Fall 15, Spring 14, Spring 13, Fall 12, Spring 12, Fall 11

\texttc{蕭正堂紀念獎學金} (Prof. Cheng-Tang Hsiao Memorial Scholarship)                  \hfill 2014

\texttc{胡達開先生紀念獎學金} (Prof. Ta-Kai Hu Memorial Scholarship)                     \hfill 2013
...
\work{DNA data storage} (archival storage),
...
\begin{thebibliography}{C99}
    ...
    \bibitem[C11]{C11} V. Guruswami, H.-P. Wang.
